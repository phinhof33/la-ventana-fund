  ...
  return (
    <html lang={lang}>
      ...
      <body>
        ...
        >
          <a href="/" style={{ fontFamily: "var(--font-display)", textDecoration: "none", lineHeight: 1.15, display: "flex", flexDirection: "column" }}>
            <span style={{ fontWeight: 600, fontSize: 17 }}>Collective Coffers</span>
            <span style={{ fontFamily: "var(--font-mono)", fontWeight: 400, fontSize: 11, letterSpacing: "0.06em", textTransform: "uppercase", color: "var(--brass)" }}>
              La Ventana
            </span>
          </a>
