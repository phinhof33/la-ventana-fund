  ...
  return (
    <main className="wrap" style={{ paddingTop: 56, paddingBottom: 80, maxWidth: 480 }}>
      ...
      <h1 style={{ fontSize: 28, marginTop: 10 }}>
        {needsOnboarding ? "Welcome" : `${profile?.first_name} ${profile?.last_initial || ""}`}
      </h1>

      {needsOnboarding && (
        <p style={{ opacity: 0.8, marginTop: 10, fontSize: 15 }}>
          Add your first name and last initial so people can recognize you on the ledger instead of seeing your email. A photo is optional.
        </p>
      )}
      ...
      {!isActive && !needsOnboarding && (
        <div style={{ marginTop: 20, padding: 20, background: "var(--ink-raised)", borderRadius: 16 }}>
          <p style={{ margin: 0, opacity: 0.9 }}>
            Join for $5 a month to nominate ideas and vote on what we buy.
          </p>
